...
///     nullable value-type snapshot that cannot be assigned atomically, so a torn read is genuinely possible
...
///     change it.
/// </remarks>
internal sealed class GitLabRateLimitTracker : IGitLabRateLimitTracker
{
