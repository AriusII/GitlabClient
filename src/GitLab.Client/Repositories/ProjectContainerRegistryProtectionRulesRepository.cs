...
internal sealed class ProjectContainerRegistryProtectionRulesRepository(IGitLabApiConnection connection)
    : IProjectContainerRegistryProtectionRulesRepository
{
