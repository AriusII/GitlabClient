...
internal sealed class TemplatesRepository(IGitLabApiConnection connection) : ITemplatesRepository
{
    ...
    public Task<GitLabLicenseTemplate> GetLicenseAsync(string name, string? project = null, string? fullname = null,
        CancellationToken cancellationToken = default)
    {
