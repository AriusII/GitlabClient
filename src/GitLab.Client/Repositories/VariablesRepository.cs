...
internal sealed class VariablesRepository(IGitLabApiConnection connection) : IVariablesRepository
{
    /// <summary>
    ...
    public Task DeleteGroupVariableAsync(GroupId groupId, string key, CancellationToken cancellationToken = default)
    {
        return connection.DeleteAsync(
            GitLabRouteBuilder.Create("groups")
                .Segment(groupId)
    ...
    public Task<GitLabVariable> CreateInstanceVariableAsync(CreateVariableRequest request,
        CancellationToken cancellationToken = default)
    {
        return connection.PostAsync(
    ...
    public Task<GitLabVariable> UpdateInstanceVariableAsync(string key, UpdateVariableRequest request,
        CancellationToken cancellationToken = default)
    {
        return connection.PutAsync(
            InstanceVariables()
