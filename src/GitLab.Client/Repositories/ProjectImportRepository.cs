...
internal sealed class ProjectImportRepository(IGitLabApiConnection connection) : IProjectImportRepository
{
    ...
    public Task<GitLabProjectImportStatus> GetRelationImportStatusAsync(ProjectId projectId,
        CancellationToken cancellationToken = default)
    {
        return connection.GetAsync(
