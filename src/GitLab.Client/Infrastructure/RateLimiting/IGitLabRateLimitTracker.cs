...
/// <remarks>
///     Read-only on purpose: writing is the pipeline's job (see <c>IGitLabRateLimitWriter</c>), and a consumer
///     overwriting the library's own observation of its quota would be a bug with no upside. Note also that
