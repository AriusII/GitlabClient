...
internal sealed class DependencyProxyClient(IGitLabApiConnection connection) : IDependencyProxyClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Maven package registry route (PackagesGenericClient.ProjectMavenRoute), it is escaped as one
    ...
    {
        // packageName is escaped as one segment for the same reason PackagesNpmClient escapes it:
