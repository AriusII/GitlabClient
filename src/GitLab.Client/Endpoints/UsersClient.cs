...
internal sealed class UsersClient(IGitLabApiConnection connection) : IUsersClient
{
    ...
    public Task<GitLabUser> GetAsync(long userId, UserGetOptions options,
        CancellationToken cancellationToken = default)
    {
        return connection.GetAsync(
            GitLabRouteBuilder.Create("users").Segment(userId).QueryFrom(options).Build(),
            GitLabJsonContext.Default.GitLabUser,
            cancellationToken);
    }
    ...
    public Task<GitLabUser> CreateAsync(CreateUserRequest request, GitLabFileUpload avatar,
        CancellationToken cancellationToken = default)
    {
        ...
        return connection.PostFileAsync(
            ...
            GitLabFormFields.FromRequest(request, GitLabJsonContext.Default.CreateUserRequest),
            GitLabJsonContext.Default.GitLabUser,
            cancellationToken);
    }
    ...
    public Task<GitLabUser> UpdateAsync(long userId, UpdateUserRequest request, GitLabFileUpload avatar,
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        ArgumentNullException.ThrowIfNull(avatar);
        ...
        return connection.PutFileAsync(
            GitLabRouteBuilder.Create("users").Segment(userId).Build(),
            avatar with { FieldName = "avatar" },
            GitLabFormFields.FromRequest(request, GitLabJsonContext.Default.UpdateUserRequest),
            GitLabJsonContext.Default.GitLabUser,
            cancellationToken);
    }
