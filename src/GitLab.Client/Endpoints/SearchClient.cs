...
internal sealed class SearchClient(IGitLabApiConnection connection) : ISearchClient
{
    private const string ProjectsScope = "projects";

    private const string GroupsScope = "groups";
    ...
    public IAsyncEnumerable<GitLabGroup> SearchGroupsAsync(string search, SearchListOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        return SearchInstanceAsync(search, GroupsScope, options, GitLabJsonContext.Default.GitLabGroupArray,
            cancellationToken);
    }

    public IAsyncEnumerable<GitLabCommit> SearchCommitsAsync(string search, SearchListOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        return SearchInstanceAsync(search, CommitsScope, options, GitLabJsonContext.Default.GitLabCommitArray,
            cancellationToken);
    }

    public IAsyncEnumerable<GitLabNote> SearchNotesAsync(string search, SearchListOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        return SearchInstanceAsync(search, NotesScope, options, GitLabJsonContext.Default.GitLabNoteArray,
            cancellationToken);
    }

    public IAsyncEnumerable<GitLabMilestone> SearchMilestonesAsync(string search, SearchListOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        return SearchInstanceAsync(search, MilestonesScope, options, GitLabJsonContext.Default.GitLabMilestoneArray,
            cancellationToken);
    }
    ...
    public IAsyncEnumerable<GitLabGroup> SearchGroupGroupsAsync(GroupId groupId, string search,
        SearchListOptions? options = null, CancellationToken cancellationToken = default)
    {
        return SearchGroupAsync(groupId, search, GroupsScope, options, GitLabJsonContext.Default.GitLabGroupArray,
            cancellationToken);
    }
