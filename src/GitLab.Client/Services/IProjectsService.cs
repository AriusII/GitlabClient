...
/// <summary>
///     Business-orchestration layer for Projects, sitting between the public <c>IProjectsClient</c>
///     controller and <c>IProjectsRepository</c>'s raw GitLab access. Mirrors the repository's method
///     shapes 1:1 today (its implementation is generated); this is the seam where request validation,
///     caching, or cross-resource composition would go once a resource needs more than pass-through.
/// </summary>
