...
///     <see cref="CreateDiscussionRequest" /> on the merge request and commit routes; GitLab rejects it
///     everywhere else.
///     <para>
...
///         branch, and <see cref="HeadSha" /> the head of the source branch. All three, plus
///         <see cref="PositionType" />, are mandatory; which of the remaining members apply depends on the
///         position type - the line and path members for <see cref="GitLabNotePositionType.Text" />, the
///         pixel members for <see cref="GitLabNotePositionType.Image" />.
///     </para>
///     <para>
...
public sealed record GitLabNotePosition
{
    ...
    public required GitLabNotePositionType PositionType { get; init; }
