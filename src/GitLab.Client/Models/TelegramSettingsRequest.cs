...
/// <summary>
///     Request body for <c>PUT /projects/:id/services/telegram</c> - GitLab's older path spelling for
///     the Telegram integration (post events to a Telegram chat).
/// </summary>
public sealed record TelegramSettingsRequest
{
