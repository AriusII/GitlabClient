...
/// <summary>
///     Request body for <c>PUT /projects/:id/hooks/:hook_id/url_variables/:key</c> - the variable name
...
///     </para>
/// </summary>
public sealed record UpdateProjectHookUrlVariableRequest
{
    ...
    {
        return "UpdateProjectHookUrlVariableRequest { Value = <redacted> }";
    }
}