...
/// <summary>
///     A group's push rules (<c>/groups/:id/push_rule</c>) - the defaults applied to every push rule of a
///     newly created project inside the group. Managing these requires the Owner role for the group, or
///     administrator access to the instance.
///     <para>
///         A group has at most one push rule resource; GitLab answers <c>404</c> for the <c>GET</c> and
///         <c>DELETE</c> routes when none has been configured yet.
///     </para>
/// </summary>
public sealed record GitLabGroupPushRule
{
