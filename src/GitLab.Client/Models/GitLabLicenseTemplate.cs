...
///     <c>GET /templates/licenses/:name</c>. Unlike the plain <see cref="GitLabTemplate" /> shape this
...
public sealed record GitLabLicenseTemplate
{
    ...
    /// <summary>
    ///     The license's full name - <c>GNU General Public License v3.0</c>. This is also what the
    ///     <c>{name}</c> path parameter of the retrieve endpoint matches.
    /// </summary>
