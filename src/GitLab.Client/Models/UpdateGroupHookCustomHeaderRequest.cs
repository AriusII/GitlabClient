...
/// <summary>
///     Request body for <c>PUT /groups/:id/hooks/:hook_id/custom_headers/:key</c> - the header name
...
///     </para>
/// </summary>
public sealed record UpdateGroupHookCustomHeaderRequest
{
    ...
    {
        return "UpdateGroupHookCustomHeaderRequest { Value = <redacted> }";
    }
}