...
public sealed record GitLabJob
{
    ...
    /// <summary>
    ///     The pipeline this job triggered in another project. Set only on a trigger (bridge) job, which is
    ///     what <c>ListTriggerJobsAsync</c> returns; null on every ordinary job.
    /// </summary>
