...
/// <summary>
///     Request body for <c>POST /projects/:id/approval_rules</c> and <c>POST /groups/:id/approval_rules</c>.
///     <para>
///         The group endpoint accepts a strict subset of these members (name, approvals required, rule type,
///         user ids and group ids). Unset members are omitted from the payload, so the project-only members
///         simply never reach a group call.
///     </para>
///     <para>
