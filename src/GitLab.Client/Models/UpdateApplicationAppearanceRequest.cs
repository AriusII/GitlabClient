...
/// <summary>
///     The text and boolean fields of <c>PUT /application/appearance</c>, sent as a plain JSON body.
///     <para>
...
///         <c>multipart/form-data</c> requests rather than folding into the JSON payload alongside
