...
/// <summary>
///     Request body for <c>PUT /projects/:id/services/webex-teams</c> - GitLab's older path spelling
///     for the Webex Teams integration (post events to a Webex space).
/// </summary>
public sealed record WebexTeamsSettingsRequest
{
