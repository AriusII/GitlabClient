...
/// <summary>Variables for a curated cursor-paginated namespace work-items query.</summary>
public sealed record GitLabWorkItemsQueryVariables
{
    /// <summary>Initializes a namespace work-items page request.</summary>
    ...
    public GitLabWorkItemsQueryVariables(string fullPath, int? first = null, string? after = null)
    {
