...
/// <summary>The payload returned by the GitLab GraphQL <c>workItemCreate</c> mutation.</summary>
/// <remarks>
...
/// </remarks>
public sealed record GitLabWorkItemCreatePayload
{
    /// <summary>The created work item, or null when the mutation reported errors.</summary>
