...
public sealed record GitLabDeployKey
{
    ...
    /// </summary>
    public IReadOnlyList<GitLabProjectIdentity>? ProjectsWithWriteAccess { get; init; }
    ...
    ///     project-scoped update - never on the project-scoped list, get or add shape.
    /// </summary>
    public IReadOnlyList<GitLabProjectIdentity>? ProjectsWithReadonlyAccess { get; init; }
}