...
/// <summary>
///     Request body for <c>POST /projects/:id/push_rule</c> and <c>POST /groups/:id/push_rule</c>. Use
///     only when the project or group does not already have push rules configured - both routes exist to
///     create the single push rule resource, not to add to it.
/// </summary>
public sealed record CreatePushRuleRequest
{
