...
/// <summary>
///     Request body for <c>POST /projects/:id/hooks</c>.
///     <para>
...
///     </para>
/// </summary>
public sealed record CreateProjectHookRequest
{
    ...
    ///     Write-only: it is never present on <see cref="GitLabProjectHook" />, which reports only
    ///     <see cref="GitLabProjectHook.TokenPresent" />.
    /// </summary>
