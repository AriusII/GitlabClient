...
/// <summary>
///     Request body for <c>PUT /hooks/:hook_id/custom_headers/:key</c> - the header name travels in the
...
///     </para>
/// </summary>
public sealed record UpdateSystemHookCustomHeaderRequest
{
    ...
    {
        return "UpdateSystemHookCustomHeaderRequest { Value = <redacted> }";
    }
}