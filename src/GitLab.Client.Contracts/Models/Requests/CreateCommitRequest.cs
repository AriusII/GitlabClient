...
public sealed record CreateCommitRequest
{
    ...
    /// <summary>
    ///     Creates a commit even when <see cref="Actions" /> is empty. GitLab otherwise rejects an empty
    ///     action collection; this option is available from GitLab 18.8 onward.
    /// </summary>
