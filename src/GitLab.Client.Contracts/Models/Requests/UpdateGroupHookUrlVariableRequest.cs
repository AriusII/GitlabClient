...
/// <summary>
///     Request body for <c>PUT /groups/:id/hooks/:hook_id/url_variables/:key</c> - the variable name
...
///     </para>
/// </summary>
public sealed record UpdateGroupHookUrlVariableRequest
{
    ...
    {
        return "UpdateGroupHookUrlVariableRequest { Value = <redacted> }";
    }
}