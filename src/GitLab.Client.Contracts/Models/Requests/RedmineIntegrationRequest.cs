...
/// <summary>Settings for the Redmine integration (<c>PUT /projects/:id/integrations/redmine</c>).</summary>
public sealed record RedmineIntegrationRequest
{
    /// <summary>URL of the Redmine project.</summary>
