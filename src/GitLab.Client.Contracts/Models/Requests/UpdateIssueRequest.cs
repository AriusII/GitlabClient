...
public sealed record UpdateIssueRequest
{
    ...
    /// <summary>
    ///     The database ID of the epic to associate with the issue. This replaces the deprecated
    ///     <c>epic_iid</c> field and is mutually exclusive with it at the GitLab API boundary.
    /// </summary>
