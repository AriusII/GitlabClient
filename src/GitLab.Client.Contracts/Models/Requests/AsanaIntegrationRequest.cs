...
/// <summary>Settings for the Asana integration (<c>PUT /projects/:id/integrations/asana</c>).</summary>
public sealed record AsanaIntegrationRequest
{
    /// <summary>User API token used to create task comments.</summary>
