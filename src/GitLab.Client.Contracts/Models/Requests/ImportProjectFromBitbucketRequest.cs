...
public sealed record ImportProjectFromBitbucketRequest
{
    ...
    private bool PrintMembers(StringBuilder builder)
    {
        ...
        builder.Append("BitbucketEmail = ")
            .Append(string.IsNullOrEmpty(BitbucketEmail) ? "[none]" : "[redacted]")
            .Append(", BitbucketApiToken = ")
            .Append(string.IsNullOrEmpty(BitbucketApiToken) ? "[none]" : "[redacted]")
            .Append(", RepoPath = ").Append(RepoPath)
