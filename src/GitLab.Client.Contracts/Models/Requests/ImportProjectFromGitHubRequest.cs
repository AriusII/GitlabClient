...
public sealed record ImportProjectFromGitHubRequest
{
    ...
    private bool PrintMembers(StringBuilder builder)
    {
        ...
        builder.Append("PersonalAccessToken = ")
            ...
            .Append(", RepoId = ").Append(RepoId)
            .Append(", TargetNamespace = ").Append(TargetNamespace)
            .Append(", NewName = ").Append(NewName)
            .Append(", GithubHostname = ").Append(GithubHostname is null ? "[none]" : "[redacted]")
            .Append(", OptionalStages = ").Append(OptionalStages.HasValue ? "[present]" : "[none]")
            .Append(", TimeoutStrategy = ").Append(TimeoutStrategy)
            .Append(", PaginationLimit = ").Append(PaginationLimit);
