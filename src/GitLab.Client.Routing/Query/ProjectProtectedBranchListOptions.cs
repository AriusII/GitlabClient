...
/// <summary>
///     Filters for listing a project's protected branches
///     (<c>GET /projects/:id/protected_branches</c>).
/// </summary>
[GitLabQuery]
public readonly record struct ProjectProtectedBranchListOptions
{
