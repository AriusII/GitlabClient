...
public readonly record struct TodoListOptions
{
    ...
    /// <summary>
    ///     The first page to fetch. The asynchronous stream then follows GitLab's <c>Link: rel="next"</c>
    ///     headers, so this is useful for resuming after pages already processed.
    /// </summary>
