...
public sealed class TriggersRepositoryTests
{
    ...
    public async Task ListAsync_BuildsTriggersRoute_AndDeserializesEachTrigger()
    {
        ...
        TriggersRepository repository = new(connection);
    ...
    [Fact]
    public async Task TriggerPipelineAsync_PostsTokenAndVariables_ToTheSingularTriggerRoute()
    {
        string? sentBody = null;
        using StubHttpMessageHandler handler = new(request =>
        {
