...
public sealed class InvitationsRepositoryTests
{
    ...
    public async Task ListForProjectAsync_BuildsInvitationsRoute_WithQueryOptions_AndDeserializesInvitations()
    {
        ...
        InvitationsRepository repository = new(connection);

        InvitationListOptions options = new() { Query = "member@example.org", PerPage = 20 };
