...
public sealed class MilestonesRepositoryTests
{
    ...
    public async Task GetAsync_BuildsExpectedRoute_AndDeserializesMilestone()
    {
        ...
        MilestonesRepository repository = new(connection);
    ...
    public async Task ListAsync_BuildsExpectedRouteWithQuery_AndStreamsAllItems()
    {
        ...
        MilestoneListOptions options = new() { State = "active", PerPage = 50 };
    ...
    public async Task UpdateAsync_PutsTheStateEventVerb()
    {
        ...
        UpdateMilestoneRequest request = new() { StateEvent = "close" };
    ...
    public async Task ListIssuesAsync_BuildsTheMilestoneIssuesRoute_AndDeserializesIssues()
    {
        ...
        Assert.Equal("https://gitlab.example/api/v4/projects/123/milestones/42/issues",
            handler.LastRequest?.RequestUri?.AbsoluteUri);
    ...
    public async Task ListMergeRequestsAsync_BuildsTheMilestoneMergeRequestsRoute()
    {
        ...
        Assert.Equal("https://gitlab.example/api/v4/projects/gitlab-org%2Fgitlab/milestones/42/merge_requests",
            handler.LastRequest?.RequestUri?.AbsoluteUri);
    ...
    public async Task ListForGroupAsync_ProjectsTheGroupOnlyDescendantsFilter()
    {
        ...
        {
            State = "active", IncludeAncestors = true, IncludeDescendants = true, PerPage = 20
        };
    ...
    public async Task UpdateForGroupAsync_PutsToTheGroupMilestoneRoute()
    {
        ...
        UpdateMilestoneRequest request = new() { Title = "Q1 hardening", DueDate = new DateOnly(2026, 3, 31) };
        ...
        Assert.Equal("https://gitlab.example/api/v4/groups/9970/milestones/12",
            handler.LastRequest?.RequestUri?.AbsoluteUri);
        Assert.Equal("""{"title":"Q1 hardening","due_date":"2026-03-31"}""", sentBody);
    }
    ...
    public async Task ListIssuesForGroupAsync_BuildsTheGroupMilestoneIssuesRoute()
    {
        ...
        Assert.Equal("https://gitlab.example/api/v4/groups/9970/milestones/12/issues",
            handler.LastRequest?.RequestUri?.AbsoluteUri);
    }
    ...
    public async Task ListMergeRequestsForGroupAsync_BuildsTheGroupMilestoneMergeRequestsRoute()
    {
        ...
        Assert.Equal("https://gitlab.example/api/v4/groups/9970/milestones/12/merge_requests",
            handler.LastRequest?.RequestUri?.AbsoluteUri);
    }
