...
public sealed class ProtectedBranchesRepositoryTests
{
    [Fact]
    public async Task ListAsync_BuildsProtectedBranchesRoute_AndDeserializesAllPages()
    {
        ...
        ProtectedBranchesRepository repository = new(connection);
    ...
    public async Task ListForGroupAsync_BuildsTheGroupRoute_AndProjectsTheSearchOption()
    {
        ...
        GroupProtectedBranchListOptions options = new() { Search = "release", PerPage = 30 };
    ...
    [Fact]
    public async Task GetForGroupAsync_EscapesTheWildcardName_AndDeserializesTheUnprotectAccessLevels()
    {
        const string Json = """
                            {
                              "id": 5,
                              ...
                              "merge_access_levels": [
                                { "access_level": 30, "access_level_description": "Developers" }
                              ],
                              "unprotect_access_levels": [
                                { "access_level": 60, "access_level_description": "Administrators" }
                              ]
                            }
                            """;
    ...
    public async Task ProtectForGroupAsync_PostsTheAccessLevelsAndAllowedToArrays()
    {
        ...
        ProtectBranchRequest request = new()
        {
            ...
            AllowedToMerge = [new ProtectedBranchAccessRequest { UserId = 7 }]
        };
        ...
        Assert.Contains("\"allowed_to_merge\":[{\"user_id\":7}]", sentBody, StringComparison.Ordinal);
