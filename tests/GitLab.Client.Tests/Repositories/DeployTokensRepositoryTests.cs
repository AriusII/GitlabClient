...
public sealed class DeployTokensRepositoryTests
{
    ...
    public async Task ListAsync_BuildsInstanceRoute_AndDeserializesTheToken()
    {
        ...
        DeployTokensRepository repository = new(connection);
    ...
    public async Task ListAsync_ProjectsTheListOptionsOntoTheQueryString()
    {
        ...
        DeployTokenListOptions options = new() { Active = true, PerPage = 50 };
        ...
        Assert.Equal("https://gitlab.example/api/v4/deploy_tokens?active=true&per_page=50",
