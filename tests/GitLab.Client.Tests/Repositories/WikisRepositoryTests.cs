...
public sealed class WikisRepositoryTests
{
    ...
    public async Task ListForProjectAsync_BuildsWikisRoute_WithContentQuery_AndDeserializesPages()
    {
        ...
        WikisRepository repository = new(connection);
    ...
    public async Task CreateForProjectAsync_PostsSerializedBody_AndReturnsPageWithServerDerivedSlug()
    {
        ...
        {
            Title = "Release Notes", Content = "Notes", Format = "asciidoc", FrontMatter = frontMatter.RootElement
        };
    ...
    [Fact]
    public async Task UploadAttachmentForProjectAsync_PostsMultipartFormData_WithOptionalBranchField()
    {
        string? sentBody = null;
    ...
    [Fact]
    public async Task UploadAttachmentForGroupAsync_PostsToGroupAttachmentsRoute_AndEncodesNamespacedGroupPath()
    {
        string? sentBody = null;
        using StubHttpMessageHandler handler = new(request =>
        {
