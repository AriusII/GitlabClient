...
public sealed class LabelsRepositoryTests
{
    ...
    public async Task ListAsync_BuildsProjectScopedRoute_AndDeserializesLabels()
    {
        ...
        LabelsRepository repository = new(connection);
    ...
    [Fact]
    public async Task DeleteAsync_SendsDeleteToTheNamedRoute()
    {
        using StubHttpMessageHandler handler = new(_ => new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = new StringContent(ProjectLabelJson, Encoding.UTF8, "application/json")
        ...
        await repository.DeleteAsync(42, "type::bug", TestContext.Current.CancellationToken);
    ...
    [Fact]
    public async Task PromoteAsync_PutsToThePromoteRoute_WithNoRequestBody()
    {
        using StubHttpMessageHandler handler = new(_ => new HttpResponseMessage(HttpStatusCode.OK)
        {
        ...
        await repository.PromoteAsync(42, "type::bug", TestContext.Current.CancellationToken);
