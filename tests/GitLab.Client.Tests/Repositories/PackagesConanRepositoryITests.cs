...
/// <summary>
///     Covers <c>PackagesConanRepository.I.cs</c> - the "Packages: Conan" v2 package-revision file upload,
...
///     existed in <c>PackagesConanRepository.V2.cs</c>; see that file's coverage in
///     <c>PackagesConanRepositoryTests.cs</c>).
/// </summary>
public sealed class PackagesConanRepositoryITests
{
    // Same coordinates as PackagesConanRepositoryTests: '+' proves package_username round-trips through
    // .Escaped(...), not .Literal(...).
