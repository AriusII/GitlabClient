...
///     snippet/vulnerability note routes. <see cref="NotesClient" /> and every method exercised here
///     already existed before this scope's work began (see <c>NotesEndpointTests</c>) - this file only
