...
/// <summary>
///     <see cref="IntegrationsClient.ListServicesAsync" />: the list-all-active-integrations
///     operation the spec still exposes under the older <c>/projects/:id/services</c> path, alongside
///     <see cref="IntegrationsClient.ListAsync" />'s current <c>/integrations</c> route (see
...
///     exactly like the modern route. <see cref="IntegrationsClient.ListServicesAsync" /> is
///     <see cref="ObsoleteAttribute" /> in favour of <see cref="IntegrationsClient.ListAsync" />,
