...
///     list - all five verbs already exist on <see cref="NotesClient" /> (built by an earlier round),
...
///     <c>NotesEndpointTests.cs</c>, which other parts of this same round are also extending.
/// </summary>
